...
class TestGinPotionFeedback:
    ...
    def _navigate_to_feedback_form(self):
        ...
        try:
            ...
            self.wait.until(EC.element_to_be_clickable((By.XPATH, SmartpadFeedbackLocators.gin_locator))).click()
    ...
    def test_submit_feedback(self):
        ...
        try:
            ...
            self.excel = ExcelFunctions(SmartpadFeedbackData.excel_file, SmartpadFeedbackData.sheet_number_1)
